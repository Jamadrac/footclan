  ...
  return (
    <footer className="body-font bg-black bg-opacity-90 w-full text-white pt-14 px-4 md:px-8">
      ...
      <div className=" w-full justify-between flex border-t pt-8 border-gray-600 md:flex-row flex-col-reverse gap-3 pb-12 items-center px-8 lg:px-20">
        ...
        <div className="flex">
          <a
            ...
            className=" text-white border hover:bg-black bg-[#202020] px-4 py-2 rounded-2xl"
          >
            Access your account
          </a>
        </div>
      ...
      <div className="flex w-full px-8 lg:px-20 text-gray-500 text-center md:text-left pb-10">
        <p>
          It&#39;s important to note that while an asset is in a remote area gps
          services my not work as expected but the moments its in a network area
          the the gps tracker will broat cast its loction with last 48hour
          journey.{" "}
        </p>
      </div>
    </footer>
